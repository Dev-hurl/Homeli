...
final bookingRequests = [
  BookingRequestModel(
    ...
    listingImage: 'assets/images/elite-prop.jpg',
    listingName: 'The Glass Pavilion, Soho',
    listingPrice: '\$3,850/mo',
    visitType: 'Private Guided Tour',
    scheduledTime: 'Thu, Oct 24 • 3:30 PM',
    guestNote: 'Hello Larry, I\'m an architect relocating from London. Looking for a quiet space for 6+ months. Excited to see the high ceilings.',
  ),
  BookingRequestModel(
    ...
    listingImage: 'assets/images/naksha.jpg',
  ...
  BookingRequestModel(
    ...
    listingImage: 'assets/images/new-uk-homes.png',
    listingName: 'Chelsea Townhouse',
    scheduledTime: 'Sat, Oct 26 • 11:00 AM',
    listingPrice: '\$3200/mo',
  ),
];
